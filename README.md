...
>>Professional Focus Areas
  ...
  * AI Integration
  * Data Analysis
  * Personal Portfolios & Interactive Brochures
    
>>Key Achievements
  
  * Oracle Certified Associate (Java SE-8 scored 93%)
  * Nominated for Ministry of Youth & Sports website enhancement project 
  * Completed IEEE Web Development Supplementary Program 
  * Represented at Lebanese National Student Competition with an AI-powered learning platform (LNSC 2025) 
  * MIT App Inventor workshop assistant & instructor support 
    
>>Technologies & Skills

- Programming Languages: JavaScript, C#, Java, PHP, Python
- Frameworks & Libraries: .NET, jQuery, Bootstrap, AJAX , three.js , chart.js
- Web Technologies: HTML5, CSS3
- Databases: MySql , MongoDB , Neo4j , FireBase
- Tools & Platforms: Microsoft Visual Studio, Visual Studio Code, Git, Microsoft Power BI , Excel , Canva
...
>>Contact / Get Involved
  ...
  * Call to “Build with Me” and connect via site contact (as displayed on homepage) 
